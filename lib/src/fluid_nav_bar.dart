...
class _FluidNavBarState extends State<FluidNavBar> with TickerProviderStateMixin {
  ...
  final gradient = LinearGradient(
    colors: widget.style!.barColorList ?? [Colors.white],
...
class _BackgroundCurvePainter extends CustomPainter {
  ...
  _BackgroundCurvePainter(double x, double normalizedY, Gradient gradient)
      : _x = x,
        _normalizedY = normalizedY,
        _gradient = gradient;
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final paint = Paint()
      ..shader = _gradient.createShader(Rect.fromLTWH(0, 0, size.width, size.height));
  ...
  @override
  bool shouldRepaint(_BackgroundCurvePainter oldPainter) {
    return _x != oldPainter._x || _normalizedY != oldPainter._normalizedY || _gradient != oldPainter._gradient;
  }
}